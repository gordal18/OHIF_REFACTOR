...
Package.onUse(function(api) {
    ...
    api.addFiles('client/components/viewer/shareDialog/shareDialog.html', 'client');
    api.addFiles('client/components/viewer/shareDialog/shareDialog.js', 'client');
    api.addFiles('client/components/viewer/shareDialog/shareDialog.styl', 'client');

    api.addFiles('client/components/viewer/reportDialog/reportDialog.html', 'client');
    api.addFiles('client/components/viewer/reportDialog/reportDialog.js', 'client');
    api.addFiles('client/components/viewer/reportDialog/reportDialog.styl', 'client');

    api.addFiles('client/components/viewer/contextMenu/contextMenu.html', 'client');
    api.addFiles('client/components/viewer/contextMenu/contextMenu.js', 'client');
    api.addFiles('client/components/viewer/contextMenu/contextMenu.styl', 'client');
